...
# PROMPT='%{$bg[black]%} %M %{$reset_color%}%{$fg[black]%}%{$reset_color%}\[\e[48;5;27m\]\[\e[38;5;236m\]\[\e[48;5;27m\]\[\e[38;5;255m\]  \W \[\e[48;5;236m\]\[\e[38;5;27m\]\[\e[48;5;236m\]\[\e[38;5;255m\]  \[\e[0m\]\[\e[38;5;236m\]\[\e[0m\]'
# PROMPT='%{$bg[cyan]%}%m%{$fg[yellow]%}  %{$fg[blue]%}%3~$(git_colored_prompt) %{$fg[yellow]%}%% %{$reset_color%}'